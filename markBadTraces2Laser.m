...
function [unselectedIndices, selectedIndices] = markBadTraces2Laser(traces,titl_e, laserstart, laserend) % taxis is a vector of times; traces is a time point x samples matrix
    selectedIndices = [];
