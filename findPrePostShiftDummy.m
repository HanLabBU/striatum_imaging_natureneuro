function [totalXShift, totalYShift, currFig,Lines]= findPrePostShiftDummy(premap, postmap)
    
    Lines = drawLinesOnImage(premap);
    currFig1 = gcf;
    movegui('west')
    
    [currFig2,Min, Max] = plotOverlayLinesContrastAdjust(Lines, postmap);
