function [pvals, stat] = plot_and_stats_triggeredfluor_split(fun_handle, inttype,tit_le,fi)
...
[pvals, stat] = compareEventTriggeredSigInds(act1,act1,sigInds1,inttype,40);
savePDF(gcf,sprintf('figures/%s/%striggeredfluorescence_%sonly_bar.pdf',date,strrep(tit_le,' ','_'),inttype));
